...
const App = {
    ...
    _renderCasesReport: function(data) {
        ...
        var statusColors = { 'Closed': '#123015', 'Open': '#d64000', 'Escalated': '#d64000', 'New': '#123015', 'In Progress': '#e9b045', 'Pending': '#123015' };
        var fallbackColors = ['#d64000', '#123015', '#e9b045', '#ffffff', '#d64000', '#123015', '#e9b045'];
            ...
            this._casesReportCharts.status = new Chart(statusCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['#d64000', '#123015', '#d64000', '#123015', '#e9b045', '#123015', '#e9b045']
                    }]
                },
    ...
    updateProactiveTable: function(data) {
        ...
        if (ctx) {
            ...
            var colors = ['#d64000', '#123015', '#e9b045', '#ffffff', '#d64000', '#123015', '#e9b045'];
    ...
    renderLeaderboardRows: function() {
        ...
        tbody.innerHTML = rankings.slice(0, this._leaderboardDisplayCount).map((agent, index) => {
            ...
            const progressColor = agent.riskClass === 'danger' ? '#d64000' :
                                 ...
                                 (agent.riskClass === 'info' ? '#123015' : '#123015'));
        ...
        this.riskChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#d64000', '#e9b045', '#123015', '#123015'],
                    borderWidth: 2,
                    borderColor: '#fff'
                }]
            },
