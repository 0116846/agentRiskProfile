...
const Charts = {
    ...
    // Color palettes
    colors: {
        primary: ['#d64000', '#123015', '#e9b045', '#4db299', '#8fcb64', '#0874e3', '#d4792a', '#fcf2da', '#e3f3ee', '#e3f1fd', '#f8eadd', '#e1f4cd'],
        ...
        neutral: ['#123015', '#e9b045', '#4db299', '#8fcb64', '#0874e3'],
        mixed:   ['#d64000', '#123015', '#e9b045', '#4db299', '#8fcb64', '#0874e3', '#d4792a', '#fcf2da', '#e3f3ee', '#e3f1fd', '#f8eadd', '#e1f4cd']
    },
        ...
        this.instances.ageDistribution = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
                        '#123015', '#4db299', '#e9b045', '#d4792a', '#d64000', '#8fcb64'
                    ],
                    borderRadius: 8
                }]
            },
        ...
        this.instances.activityTrend = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    ds('Aged Cases', 'aged', 'rgb(18,48,21)'),
                    ds('Email Changes', 'email', 'rgb(233,176,69)'),
                    ds('Short Calls', 'shortCalls', 'rgb(77,178,153)'),
                    ds('RONA', 'rona', 'rgb(143,203,100)')
                ]
            },
            options: {
                responsive: true,
